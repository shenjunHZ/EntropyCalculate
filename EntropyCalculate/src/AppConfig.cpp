...
#include "interface/GlobalDataCenter/GlobalDataCenter.h"
...
namespace common
{
    ...
    AppConfig::AppConfig(QApplication& app)
        : m_sharedMenPtr(std::make_unique<QSharedMemory>("Entropy Calculate"))
    {
        // set path
        ...
        app.setOrganizationName(QString("Entropy Calculate"));
        app.setApplicationName(QString("Entropy Calculate"));
    ...
    void AppConfig::setLog()
    {
        ...
        DLOG_SET_FILE(".\\log\\EntropyCalculate");
